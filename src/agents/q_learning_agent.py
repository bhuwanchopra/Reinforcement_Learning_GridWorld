...
class QLearningAgent:
    ...
    def visualize_learning(self, save_path='data/learning_progress.png'):
        """
    ...
    def demonstrate_policy(self, max_steps=20):
        ...
        # Reset environment
        self.env.generate_grid()
        self.env.set_positions()  # Use default positions
...
if __name__ == "__main__":
    # This code will run when q_learning_agent.py is executed directly
    from src.environments.gridworld import GridWorld
    ...
    # Add custom rewards
    env.set_custom_reward((1, 4), 0.5)
    env.set_custom_reward((4, 1), -0.5)
